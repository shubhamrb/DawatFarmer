...
public class FullBlogsListAdapter extends RecyclerView.Adapter<FullBlogsListAdapter.DashboardListViewHolder> {
    ...
    public FullBlogsListAdapter(Context mContext, OnClickListener listener) {
    ...
    public DashboardListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        root = LayoutInflater.from(mContext).inflate(R.layout.full_blog_list_item, parent, false);
