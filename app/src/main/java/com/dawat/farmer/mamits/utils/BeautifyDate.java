...
public class BeautifyDate {
    public String beautifyDate(String timestamp, String oldDate, String newDate) {
        SimpleDateFormat oldFormat = null;
        SimpleDateFormat newFormat = null;
        try {
            oldFormat = new SimpleDateFormat(oldDate, Locale.getDefault());
            newFormat = new SimpleDateFormat(newDate, Locale.getDefault());
    ...
    public String beautifyAgoDate(String timestamp) {
